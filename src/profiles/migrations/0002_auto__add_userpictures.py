...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'UserPictures'
        db.create_table(u'profiles_userpictures', (
        ...
        db.send_create_signal(u'profiles', ['UserPictures'])


    def backwards(self, orm):
        # Deleting model 'UserPictures'
        db.delete_table(u'profiles_userpictures')
    ...
    models = {
        ...
        u'profiles.userpictures': {
            'Meta': {'object_name': 'UserPictures'},
            'active': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
